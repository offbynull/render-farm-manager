...
public final class HostSelected extends Selected<HostRequirement, HostSpecification> {
    ...
    public HostSelected(HostRequirement selection, Set<HostSpecification> specification,

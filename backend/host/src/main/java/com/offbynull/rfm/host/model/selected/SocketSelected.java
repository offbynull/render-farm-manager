...
public final class SocketSelected extends Selected<SocketSelection, SocketSpecification> {
    
    private final UnmodifiableSet<CoreSelected> coresSelected;
    
    public SocketSelected(SocketSelection selection, Set<SocketSpecification> specification, Set<CoreSelected> coresSelected) {

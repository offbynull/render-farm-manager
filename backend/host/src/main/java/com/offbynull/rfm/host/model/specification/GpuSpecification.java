 ...
 */
public final class GpuSpecification extends Specification implements CapacityEnabledSpecification {
    private static final UnmodifiableSet<String> KEY_NAMES;
    
    static {
        LinkedHashSet<String> keyNames = new LinkedHashSet<>();
        keyNames.add("s_gpu_id");
    ...
    /**
     * Constructs a {@link GpuSpecification} object.
     * <p>
     * Required key properties...
     * <ul>
     * <li>s_gpu_id -- device id</li>
     * </ul>
     ...
     * {@code properties.keySet().contains("s_gpu_id")},
    ...
    public GpuSpecification(BigDecimal capacity, Map<String, Object> properties) {
        ...
        String gpuId = (String) properties.get("s_gpu_id");
    ...
    public boolean equals(Object obj) {
        ...
        final GpuSpecification other = (GpuSpecification) obj;
